...
import top.limuyang2.customtitlebar.utils.*;
...
public class CustomTitleBar extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (array != null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                float elevationValue = array.getDimension(R.styleable.CustomTitleBar_titlebar_elevation, 0);
                if (elevationValue != 0) {
    ...
    private void getCommonFieldFormTypedArray(Context context, TypedArray array) {
        mTitleBarHeight = array.getDimensionPixelOffset(R.styleable.CustomTitleBar_titlebar_height, ScreenHelper.dp2px(context, 56));

        mLeftBackDrawableRes = array.getResourceId(R.styleable.CustomTitleBar_titlebar_left_back_drawable_id, R.drawable.icon_titlebar_back);
    ...
    private TextView getTitleView() {
        if (mTitleView == null) {
            ...
            //mTitleView.getPaint().setFakeBoldText(true);//加粗
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                mTitleView.setLetterSpacing(0.12f);
            }
    ...
    public void addLeftView(View view, int viewId) {
        ...
        if (viewLayoutParams instanceof LayoutParams) {
...
//        lp.topMargin = Math.max(0, (getTopBarHeight() - getTopBarImageBtnHeight()) / 2);
    ...
    private Button generateTopBarTextButton(String text) {
        ...
        button.setTextColor(mTopBarTextBtnTextColor == null ? getContext().getResources().getColorStateList(R.color.titlebar_text_color) : mTopBarTextBtnTextColor);
...
//        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        heightMeasureSpec = MeasureSpec.makeMeasureSpec(mTitleBarHeight, MeasureSpec.EXACTLY);
